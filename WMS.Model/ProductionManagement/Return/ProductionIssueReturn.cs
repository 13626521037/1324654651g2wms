...
{
    public class ProductionIssueReturn
    {
        ...
        public List<ProductionIssueReturnLine> Lines { get; set; }

        public ProductionIssueReturn(ProductionIssue entity)
        {
            if (entity != null)
            {
                ID = entity.ID;
                ...
                Lines = new List<ProductionIssueReturnLine>();
                foreach (var line in entity.ProductionIssueLine_ProductionIssue)
                {
                    var lineModel = new ProductionIssueReturnLine();
                    lineModel.ID = line.ID;
                    lineModel.MODocNo = line.MODocNo;
                    lineModel.PickListLineNo = line.PickListLineNo;
        ...
        public ProductionIssueReturn()
        {

        }
    }

    public class ProductionIssueReturnLine
    {
        public Guid ID { get; set; }
        ...
        public List<ProductionIssueReturnLineSuggestLoc> SuggestLocs { get; set; }

        public List<ProductionIssueReturnSubLine> SubLines { get; set; }
    }

    /// <summary>
    /// 推荐库位
    /// </summary>
    public class ProductionIssueReturnLineSuggestLoc
    {
        /// <summary>
        /// 库区编码
        /// </summary>
    ...
    /// 委外发料单下架库存明细
    /// </summary>
    public class ProductionIssueReturnSubLine
    {
