...
namespace WMS.Model.SalesManagement
{
    public class SalesRMAReturn
    {
        ...
        public List<SalesRMAReturnLine> Lines { get; set; }

        public SalesRMAReturn(SalesRMA entity)
        {
            if (entity != null)
            {
                ID = entity.ID;
                ...
                Lines = new List<SalesRMAReturnLine>();
                if (entity.SalesRMALine_RMAId != null && entity.SalesRMALine_RMAId.Count > 0)
                {
                    WareHouseID = entity.SalesRMALine_RMAId[0].WareHouse.ID;
                    WareHouseCode = entity.SalesRMALine_RMAId[0].WareHouse.Code;
                    WareHouseName = entity.SalesRMALine_RMAId[0].WareHouse.Name;
                    foreach (var line in entity.SalesRMALine_RMAId)
                    {
                        Lines.Add(new SalesRMAReturnLine
                        {
                            ID = line.ID,
        ...
        public void SetSubLines(List<BaseDocInventoryRelation> relations)
        {
            ...
            {
                line.SubLines = new List<SalesRMAReturnSubLine>();
                var matchs = relations.FindAll(x => x.BusinessLineId == line.ID);
                if (matchs != null && matchs.Count > 0)
                {
                    foreach (var match in matchs)
                    {
                        line.SubLines.Add(new SalesRMAReturnSubLine
                        {
    ...
    public class SalesRMAReturnLine
    {
        public Guid ID { get; set; }
        ...
        public List<SalesRMAReturnSubLine> SubLines { get; set; }

        public List<SalesRMAReturnLineSuggestLoc> SuggestLocs { get; set; }
    }

    public class SalesRMAReturnSubLine
    {
    ...
    public class SalesRMAReturnLineSuggestLoc
    {
