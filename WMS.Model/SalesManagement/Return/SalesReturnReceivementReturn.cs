...
{
    public class SalesReturnReceivementReturn
    {
        ...
        public List<SalesReturnReceivementReturnLine> Lines { get; set; }

        public SalesReturnReceivementReturn(SalesReturnReceivement entity)
        {
            if (entity != null)
            {
                ID = entity.ID;
                ...
                Lines = new List<SalesReturnReceivementReturnLine>();
                if (entity.SalesReturnReceivementLine_ReturnReceivement != null && entity.SalesReturnReceivementLine_ReturnReceivement.Count > 0)
                {
                    WareHouseID = entity.SalesReturnReceivementLine_ReturnReceivement[0].WareHouse.ID;
                    WareHouseCode = entity.SalesReturnReceivementLine_ReturnReceivement[0].WareHouse.Code;
                    WareHouseName = entity.SalesReturnReceivementLine_ReturnReceivement[0].WareHouse.Name;
                    foreach (var line in entity.SalesReturnReceivementLine_ReturnReceivement)
                    {
                        Lines.Add(new SalesReturnReceivementReturnLine
                        {
                            ID = line.ID,
        ...
        public SalesReturnReceivementReturn()
        {
        ...
        public void SetSubLines(List<BaseDocInventoryRelation> relations)
        {
            ...
            {
                line.SubLines = new List<SalesReturnReceivementReturnSubLine>();
                var matchs = relations.FindAll(x => x.BusinessLineId == line.ID);
                if (matchs != null && matchs.Count > 0)
                {
                    foreach (var match in matchs)
                    {
                        line.SubLines.Add(new SalesReturnReceivementReturnSubLine
                        {
    ...
    public class SalesReturnReceivementReturnLine
    {
        public Guid ID { get; set; }
        ...
        public List<SalesReturnReceivementReturnSubLine> SubLines { get; set; }

        public List<SalesReturnReceivementReturnLineSuggestLoc> SuggestLocs { get; set; }
    }

    public class SalesReturnReceivementReturnSubLine
    {
    ...
    public class SalesReturnReceivementReturnLineSuggestLoc
    {
