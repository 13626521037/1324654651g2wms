...
{
    public partial class ProductionReturnIssueBatchVM : BaseBatchVM<ProductionReturnIssue, ProductionReturnIssue_BatchEdit>
    {
        public ProductionReturnIssueBatchVM()
        {
            ListVM = new ProductionReturnIssueListVM();
            LinkedVM = new ProductionReturnIssue_BatchEdit();
        }
    ...
    /// </summary>
    public class ProductionReturnIssue_BatchEdit : BaseVM
    {

        
        public List<string> ProductionManagementProductionReturnIssueBTempSelected { get; set; }
