...
{
    [Area("BaseData")]
    [ActionDescription("_Model.BaseSupplier")]
    public partial class BaseSupplierController : BaseController
    {
        #region Create
        [HttpPost]
        [ActionDescription("Sys.Create")]
        public async Task<ActionResult> Create(BaseSupplierVM vm)
        {
            ...
            else
            {
                ...
                if (!ModelState.IsValid)
                {
                    ...
                    vm.DoReInit();
                    return PartialView("../BaseSupplier/Create", vm);
                }
                else
                {
        ...
        public async Task<ActionResult> Edit(BaseSupplierVM vm)
        {
            if (!ModelState.IsValid)
            {
            ...
            else
            {
                ...
                if (!ModelState.IsValid)
                {
                    ...
                    vm.DoReInit();
                    return PartialView("../BaseSupplier/Edit", vm);
                }
                else
                {
        ...
        {
            BaseSupplierVM vm = Wtm.CreateVM<BaseSupplierVM>();
        ...
        public ActionResult DoBatchEdit(BaseSupplierBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = Wtm.CreateVM<BaseSupplierBatchVM>();
        ...
        public ActionResult Import(BaseSupplierImportVM vm, IFormCollection nouse)
        {
        ...
        public ActionResult Select_GetBaseSupplierByBaseOrganization(List<string> id)
        {
            var rv = DC.Set<BaseSupplier>().CheckIDs(id, x => x.OrganizationId).GetSelectListItems(Wtm,x=>x.SourceSystemId);
            return JsonMore(rv);
        }
