...
{
    public partial class PurchaseOutsourcingIssueApiListVM : BasePagedListVM<PurchaseOutsourcingIssueApi_View, PurchaseOutsourcingIssueApiSearcher>
    {

        protected override IEnumerable<IGridColumn<PurchaseOutsourcingIssueApi_View>> InitGridHeader()
        {
            return new List<GridColumn<PurchaseOutsourcingIssueApi_View>>{
        ...
        public override IOrderedQueryable<PurchaseOutsourcingIssueApi_View> GetSearchQuery()
        {
            var query = DC.Set<PurchaseOutsourcingIssue>()
                .Select(x => new PurchaseOutsourcingIssueApi_View
                {
				    ID = x.ID,
    ...
    public class PurchaseOutsourcingIssueApi_View : PurchaseOutsourcingIssue{
        [Display(Name = "名称")]
