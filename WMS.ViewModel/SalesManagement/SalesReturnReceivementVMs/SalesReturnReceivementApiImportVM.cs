...
{
    public partial class SalesReturnReceivementApiTemplateVM : BaseTemplateVM
    {
        ...
        public ExcelPropety BusinessDate_Excel = ExcelPropety.CreateProperty<SalesReturnReceivement>(x => x.BusinessDate);
        [Display(Name = "_Model._SalesReturnReceivement._SubmitDate")]
        public ExcelPropety SubmitDate_Excel = ExcelPropety.CreateProperty<SalesReturnReceivement>(x => x.SubmitDate);
        ...
        [Display(Name = "最后修改时间")]
        public ExcelPropety LastUpdateTime_Excel = ExcelPropety.CreateProperty<SalesReturnReceivement>(x => x.LastUpdateTime);
    ...
    public class SalesReturnReceivementApiImportVM : BaseImportVM<SalesReturnReceivementApiTemplateVM, SalesReturnReceivement>
    {
