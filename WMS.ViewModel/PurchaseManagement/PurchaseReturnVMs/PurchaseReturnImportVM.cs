...
{
    public partial class PurchaseReturnTemplateVM : BaseTemplateVM
    {
        ...
        public ExcelPropety BusinessDate_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.BusinessDate, true);
        [Display(Name = "_Model._PurchaseReturn._CreateDate")]
        public ExcelPropety CreateDate_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.CreateDate, true);
        ...
        [Display(Name = "_Model._PurchaseReturn._SourceSystemId")]
        public ExcelPropety SourceSystemId_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.SourceSystemId);
        [Display(Name = "_Model._PurchaseReturn._LastUpdateTime")]
        public ExcelPropety LastUpdateTime_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.LastUpdateTime, true);
        [Display(Name = "_Model._PurchaseReturn._CreateTime")]
        public ExcelPropety CreateTime_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.CreateTime, true);
        [Display(Name = "_Model._PurchaseReturn._UpdateTime")]
        public ExcelPropety UpdateTime_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.UpdateTime, true);
        [Display(Name = "_Model._PurchaseReturn._CreateBy")]
        public ExcelPropety CreateBy_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.CreateBy);
        [Display(Name = "_Model._PurchaseReturn._UpdateBy")]
        public ExcelPropety UpdateBy_Excel = ExcelPropety.CreateProperty<PurchaseReturn>(x => x.UpdateBy);
    ...
    public class PurchaseReturnImportVM : BaseImportVM<PurchaseReturnTemplateVM, PurchaseReturn>
    {
            //import
