...
{
    public partial class SalesRMALineRMAIdDetailListVM : BasePagedListVM<SalesRMALine_DetailView, SalesRMALineDetailSearcher>
    {
        ...
        protected override IEnumerable<IGridColumn<SalesRMALine_DetailView>> InitGridHeader()
        {
            return new List<GridColumn<SalesRMALine_DetailView>>{
        ...
        public override IOrderedQueryable<SalesRMALine_DetailView> GetSearchQuery()
        {
                
            var id = (Guid?)Searcher.RMAIdId.ConvertValue(typeof(Guid?));
            if (id == null)
                return new List<SalesRMALine_DetailView>().AsQueryable().OrderBy(x => x.ID);
            var query = DC.Set<SalesRMALine>()
                .Where(x => id == x.RMAIdId)
                .Select(x => new SalesRMALine_DetailView
                {
                    ID = x.ID,
    ...
    public partial class SalesRMALineDetailSearcher : BaseSearcher
    {
        
        [Display(Name = "_Model._SalesRMALine._RMAId")]
        public string RMAIdId { get; set; }
    }

    public class SalesRMALine_DetailView : SalesRMALine
    {
        [Display(Name = "料号")]
