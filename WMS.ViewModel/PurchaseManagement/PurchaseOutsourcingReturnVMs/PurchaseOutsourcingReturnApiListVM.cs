...
{
    public partial class PurchaseOutsourcingReturnApiListVM : BasePagedListVM<PurchaseOutsourcingReturnApi_View, PurchaseOutsourcingReturnApiSearcher>
    {

        protected override IEnumerable<IGridColumn<PurchaseOutsourcingReturnApi_View>> InitGridHeader()
        {
            return new List<GridColumn<PurchaseOutsourcingReturnApi_View>>{
        ...
        public override IOrderedQueryable<PurchaseOutsourcingReturnApi_View> GetSearchQuery()
        {
            var query = DC.Set<PurchaseOutsourcingReturn>()
                .Select(x => new PurchaseOutsourcingReturnApi_View
                {
				    ID = x.ID,
    ...
    public class PurchaseOutsourcingReturnApi_View : PurchaseOutsourcingReturn{
        [Display(Name = "名称")]
