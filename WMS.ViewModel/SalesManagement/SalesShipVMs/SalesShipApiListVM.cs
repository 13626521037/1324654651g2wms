...
{
    public partial class SalesShipApiListVM : BasePagedListVM<SalesShipApi_View, SalesShipApiSearcher>
    {

        protected override IEnumerable<IGridColumn<SalesShipApi_View>> InitGridHeader()
        {
            return new List<GridColumn<SalesShipApi_View>>{
        ...
        public override IOrderedQueryable<SalesShipApi_View> GetSearchQuery()
        {
            var query = DC.Set<SalesShip>()
                .Select(x => new SalesShipApi_View
                {
				    ID = x.ID,
    ...
    public class SalesShipApi_View : SalesShip{
        [Display(Name = "名称")]
