...
{
    [Area("BaseData")]
    [ActionDescription("_Model.BaseOperator")]
    public partial class BaseOperatorController : BaseController
    {
        #region Create
        [HttpPost]
        [ActionDescription("Sys.Create")]
        public async Task<ActionResult> Create(BaseOperatorVM vm)
        {
            ...
            else
            {
                ...
                if (!ModelState.IsValid)
                {
                    ...
                    vm.DoReInit();
                    return PartialView("../BaseOperator/Create", vm);
                }
                else
                {
        ...
        public async Task<ActionResult> Edit(BaseOperatorVM vm)
        {
            if (!ModelState.IsValid)
            {
            ...
            else
            {
                ...
                if (!ModelState.IsValid)
                {
                    ...
                    vm.DoReInit();
                    return PartialView("../BaseOperator/Edit", vm);
                }
                else
                {
        ...
        {
            BaseOperatorVM vm = Wtm.CreateVM<BaseOperatorVM>();
        ...
        public ActionResult DoBatchEdit(BaseOperatorBatchVM vm, IFormCollection nouse)
        {
        ...
        {
            var vm = Wtm.CreateVM<BaseOperatorBatchVM>();
        ...
        public ActionResult Import(BaseOperatorImportVM vm, IFormCollection nouse)
        {
        ...
        public ActionResult Select_GetBaseOperatorByBaseDepartment(List<string> id)
        {
            var rv = DC.Set<BaseOperator>().CheckIDs(id, x => x.DepartmentId).GetSelectListItems(Wtm, x => x.SourceSystemId);
            return JsonMore(rv);
        }
